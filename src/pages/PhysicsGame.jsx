...
// Physics questions
const QUESTIONS = [
  { q: "Force = mass × ?", options: ["Acceleration", "Velocity", "Energy", "Power"], answer: "Acceleration" },
  { q: "Unit of Force?", options: ["Newton", "Joule", "Watt", "Pascal"], answer: "Newton" },
  { q: "Speed of light in vacuum?", options: ["3×10^8 m/s", "1×10^6 m/s", "5×10^7 m/s", "9×10^9 m/s"], answer: "3×10^8 m/s" },
  { q: "Work = ?", options: ["Force × Distance", "Mass × Acceleration", "Energy ÷ Time", "Power × Time"], answer: "Force × Distance" },
];
  ...
  return (
    <div className="game-root">
      ...
      <nav className="navbar navbar-expand-md glassy-nav px-3 neon-glass">
        <span className="navbar-brand neon-brand">Class {className} - {subject}</span>
