...
const QUESTIONS = [
  { q: "3/4 + 1/2 = ?", options: ["5/4", "1", "7/4", "3/2"], answer: "5/4" },
  { q: "2^3 = ?", options: ["6", "8", "9", "12"], answer: "8" },
  { q: "15 × 6 = ?", options: ["90", "100", "85", "80"], answer: "90" },
  { q: "√49 = ?", options: ["6", "7", "8", "9"], answer: "7" },
];
...
export default function MathsGame({ className, goBack }) {
  ...
  return (
    <div className="game-root">
      ...
      <nav className="navbar navbar-expand-md glassy-nav px-3 neon-glass">
        <span className="navbar-brand neon-brand">Class {className}:  Maths</span>
