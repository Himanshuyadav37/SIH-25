...
// Physics questions
const QUESTIONS = [
  { q: "CPU stands for?", options: ["Central Processing Unit", "Central Program Unit", "Control Processing Unit", "Core Processing Unit"], answer: "Central Processing Unit" },

  { q: "Volatile primary memory is?", options: ["ROM", "Cache", "RAM", "SSD"], answer: "RAM" },

  { q: "Which device is an output device?", options: ["Keyboard", "Scanner", "Monitor", "Mouse"], answer: "Monitor" },

  { q: "Binary number system uses?", options: ["Digits 0–9", "Digits 0–7", "Digits 0–1", "Digits 0–15"], answer: "Digits 0–1" },

  { q: "ALU is responsible for?", options: ["Storing data", "Arithmetic and logic operations", "Displaying output", "Networking"], answer: "Arithmetic and logic operations" },
];
...
export default function ComputerScience({ className, goBack }) {
  ...
  return (
    <div className="game-root">
      ...
      <nav className="navbar navbar-expand-md glassy-nav px-3 neon-glass">
        <span className="navbar-brand neon-brand">Class : Computer Science </span>
