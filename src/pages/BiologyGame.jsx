...
// Physics questions
const QUESTIONS = [
  { q: "Basic unit of life is?", options: ["Tissue", "Organ", "Cell", "Organism"], answer: "Cell" },

  { q: "Energy currency of the cell?", options: ["DNA", "ATP", "RNA", "NADH"], answer: "ATP" },

  { q: "Photosynthesis occurs in which organelle?", options: ["Mitochondria", "Ribosome", "Chloroplast", "Nucleus"], answer: "Chloroplast" },

  { q: "Human blood carries oxygen mainly via?", options: ["Plasma", "Hemoglobin", "Platelets", "Lymph"], answer: "Hemoglobin" },

  { q: "Genetic material in most organisms is?", options: ["Protein", "Lipid", "DNA", "Starch"], answer: "DNA" },
];
...
export default function BiologyGame({ className, goBack }) {
  ...
  return (
    <div className="game-root">
      ...
      <nav className="navbar navbar-expand-md glassy-nav px-3 neon-glass">
        <span className="navbar-brand neon-brand">Class : Biology </span>
